...
public class GeneralMDMDataReleaseProxy implements com.core.general.involke.GeneralMDMDataRelease {
  private String _endpoint = null;
  private com.core.general.involke.GeneralMDMDataRelease generalMDMDataRelease = null;
  ...
  private void _initGeneralMDMDataReleaseProxy() {
    try {
      generalMDMDataRelease = (new com.core.general.involke.Generalmdmdatarelease_client_epLocator()).getGeneralMDMDataRelease_pt();
  ...
  public com.core.general.involke.GeneralMDMDataRelease getGeneralMDMDataRelease() {
    if (generalMDMDataRelease == null)
      _initGeneralMDMDataReleaseProxy();
